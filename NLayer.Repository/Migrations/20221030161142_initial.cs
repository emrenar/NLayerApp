    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 10, 30, 19, 11, 42, 53, DateTimeKind.Local).AddTicks(8728), 200m, "Kalem1", 20, null },
                    { 2, 1, new DateTime(2022, 10, 30, 19, 11, 42, 53, DateTimeKind.Local).AddTicks(8737), 250m, "Kalem2", 10, null },
                    { 3, 1, new DateTime(2022, 10, 30, 19, 11, 42, 53, DateTimeKind.Local).AddTicks(8739), 300m, "Kalem3", 50, null },
                    { 4, 2, new DateTime(2022, 10, 30, 19, 11, 42, 53, DateTimeKind.Local).AddTicks(8741), 550m, "Kitap1", 5, null }
                });
            ...
            migrationBuilder.InsertData(
                table: "ProductFeatures",
                columns: new[] { "Id", "Color", "Height", "ProductId", "Width" },
                values: new object[] { 2, "Mavi", 500, 2, 400 });
